...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        Admin::create(['name' => 'Hamza Saqib', 'email' => 'admin@gmail.com', 'role' => 'Super Admin',
        'phone' => '03239991999', 'profile_image' => 'profile_image_icon.jpg', 'password' => Hash::make('admin@12345')]);
